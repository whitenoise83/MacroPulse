...
- Calibration ID: `3576b19a-27b0-4ee4-bf59-910d9c821c1b`
...
|---|---|---|
| PAYEMS | month_open | Labour 12-Month Mean |
| PAYEMS | after_week_1 | Labour Equal-Weight Ensemble |
| PAYEMS | after_week_2 | Labour Bridge Ridge |
| PAYEMS | month_end | Labour Bridge Ridge |
| PAYEMS | pre_employment_report | Labour Bridge Ridge |
| UNRATE | month_open | Labour Equal-Weight Ensemble |
| UNRATE | after_week_1 | Labour Equal-Weight Ensemble |
| UNRATE | after_week_2 | Labour Equal-Weight Ensemble |
| UNRATE | month_end | Labour Equal-Weight Ensemble |
| UNRATE | pre_employment_report | Labour Equal-Weight Ensemble |
| CES0500000003 | month_open | Labour Bridge Ridge |
| CES0500000003 | after_week_1 | Labour Bridge Ridge |
| CES0500000003 | after_week_2 | Labour Equal-Weight Ensemble |
| CES0500000003 | month_end | Labour Equal-Weight Ensemble |
| CES0500000003 | pre_employment_report | Labour Equal-Weight Ensemble |
...
| target_series | forecast_stage | observations | rmse | mae | bias | median_ae | p90_abs_error | max_abs_error | directional_accuracy | model_name |
|---|---|---|---|---|---|---|---|---|---|---|
| CES0500000003 | after_week_1 | 85 | 5.6323 | 2.4111 | 0.6698 | 1.1263 | 4.2972 | 43.5371 | 0.9294 | Adaptive shadow |
| CES0500000003 | after_week_2 | 86 | 6.1175 | 2.3220 | 0.8662 | 1.0004 | 4.3552 | 50.8902 | 0.9535 | Adaptive shadow |
| CES0500000003 | month_end | 86 | 6.6242 | 2.5196 | 0.7009 | 1.0819 | 4.4021 | 51.8969 | 0.9419 | Adaptive shadow |
| CES0500000003 | month_open | 85 | 6.5340 | 2.5516 | 0.8723 | 1.1075 | 4.6301 | 50.4627 | 0.9412 | Adaptive shadow |
| CES0500000003 | pre_employment_report | 86 | 6.6235 | 2.5221 | 0.7289 | 1.0510 | 4.3163 | 51.8969 | 0.9419 | Adaptive shadow |
| PAYEMS | after_week_1 | 95 | 2264.6233 | 564.8812 | 72.8352 | 125.0000 | 880.6539 | 20696.0000 | 0.9053 | Adaptive shadow |
| PAYEMS | after_week_2 | 96 | 2302.9100 | 596.9917 | 55.4477 | 106.8333 | 1086.6250 | 20696.0000 | 0.8125 | Adaptive shadow |
| PAYEMS | month_end | 96 | 2304.8750 | 601.9050 | 53.1559 | 105.4167 | 1086.6250 | 20696.0000 | 0.7917 | Adaptive shadow |
| PAYEMS | month_open | 95 | 2281.7702 | 596.0212 | 7.0260 | 118.0619 | 1254.6167 | 20678.0833 | 0.8316 | Adaptive shadow |
| PAYEMS | pre_employment_report | 96 | 2305.2688 | 605.7259 | 56.2009 | 110.0565 | 1086.6250 | 20696.0000 | 0.7812 | Adaptive shadow |
| UNRATE | after_week_1 | 94 | 1.5768 | 0.4893 | 0.2130 | 0.1813 | 0.4971 | 11.6902 | 0.4787 | Adaptive shadow |
| UNRATE | after_week_2 | 95 | 1.2654 | 0.3976 | 0.1495 | 0.1850 | 0.4494 | 11.1751 | 0.4632 | Adaptive shadow |
| UNRATE | month_end | 95 | 1.2022 | 0.3793 | 0.1324 | 0.1815 | 0.4438 | 10.7554 | 0.4842 | Adaptive shadow |
| UNRATE | month_open | 94 | 2.7925 | 0.6957 | -0.0299 | 0.2045 | 0.5592 | 22.4605 | 0.4894 | Adaptive shadow |
| UNRATE | pre_employment_report | 95 | 1.1937 | 0.3598 | 0.1211 | 0.1744 | 0.4411 | 10.7004 | 0.5158 | Adaptive shadow |
...
## Fixed-policy regime performance
...
## Stable-policy intervals: exp_weighted_q80
...
| target_series | forecast_stage | observations | coverage | average_half_width | mean_interval_score | median_interval_score | minimum_prior_errors |
|---|---|---|---|---|---|---|---|
| CES0500000003 | after_week_1 | 85 | 0.8118 | 2.9847 | 15.2878 | 6.7891 | 24 |
| CES0500000003 | after_week_2 | 86 | 0.7791 | 2.8458 | 14.9360 | 5.6828 | 24 |
| CES0500000003 | month_end | 86 | 0.8023 | 2.8720 | 16.7821 | 5.8927 | 24 |
| CES0500000003 | month_open | 85 | 0.7765 | 3.0380 | 17.4227 | 6.2022 | 24 |
| CES0500000003 | pre_employment_report | 86 | 0.8140 | 2.8528 | 16.7102 | 6.0149 | 24 |
| PAYEMS | after_week_1 | 95 | 0.8316 | 486.2050 | 4284.9353 | 765.6667 | 24 |
| PAYEMS | after_week_2 | 96 | 0.8333 | 547.8897 | 4519.4166 | 700.2192 | 24 |
| PAYEMS | month_end | 96 | 0.8125 | 556.3651 | 4538.8045 | 691.3293 | 24 |
| PAYEMS | month_open | 95 | 0.8421 | 662.5587 | 4645.2929 | 604.2395 | 24 |
| PAYEMS | pre_employment_report | 96 | 0.8229 | 552.5281 | 4535.7464 | 691.4946 | 24 |
| UNRATE | after_week_1 | 94 | 0.7766 | 0.4401 | 3.5660 | 0.8520 | 24 |
| UNRATE | after_week_2 | 95 | 0.8000 | 0.3837 | 2.6827 | 0.7965 | 24 |
| UNRATE | month_end | 95 | 0.7684 | 0.3842 | 2.5826 | 0.8378 | 24 |
| UNRATE | month_open | 94 | 0.8298 | 0.4396 | 5.6497 | 0.7985 | 24 |
| UNRATE | pre_employment_report | 95 | 0.8000 | 0.3625 | 2.5510 | 0.7022 | 24 |

## Governance interpretation

The fixed map was selected from completed vintage evidence with explicit emphasis on typical error, crisis tails, bias, and stage stability. The adaptive selector uses only earlier forecast errors and remains shadow-only. Common-sample evidence must be reviewed before candidate validation; raw full-sample and shadow summaries must not be compared directly because their evaluation windows differ.