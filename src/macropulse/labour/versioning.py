...
def labour_code_hash(project_root: Path | None = None) -> str:
    ...
    paths = [
        ...
        root / "scripts" / "repair_labour_structural_missing.py",
        root / "scripts" / "calibrate_labour_intervals.py",
        root / "scripts" / "run_labour_validation.py",
        root / "scripts" / "evaluate_labour_policy.py",
        root / "scripts" / "run_labour_candidate_validation.py",
        root / "scripts" / "run_labour_news.py",
        root / "scripts" / "run_labour_operational_validation.py",
        root / "scripts" / "generate_labour_freeze_assessment.py",
        root / "scripts" / "promote_model1c_v1.py",
        root / "ui" / "labour_nowcast.py",
        root / "ui" / "labour_news.py",
