...
from macropulse.inflation.interval_calibration import run_prior_only_interval_calibration


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Calibrate Model 1B intervals from prior-only vintage forecast errors."
    )
...
def main() -> None:
    args = parse_args()
    result = run_prior_only_interval_calibration(
    ...
    print("Model 1B prior-only interval calibration complete")
