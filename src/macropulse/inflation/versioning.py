...
def inflation_code_hash(project_root: Path | None = None) -> str:
    ...
    paths = [
        ...
        root / "scripts" / "run_inflation_operational_validation.py",
        root / "scripts" / "generate_inflation_freeze_assessment.py",
        root / "scripts" / "promote_model1b_v1.py",
        root / "scripts" / "run_inflation_news.py",
        root / "ui" / "inflation_nowcast.py",
        root / "ui" / "inflation_news.py",
