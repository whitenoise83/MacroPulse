...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run the governed Model 1B live inflation forecast."
    )
    parser.add_argument(
        "--as-of",
        help="Optional information cutoff in YYYY-MM-DD format. Current stored observations are filtered to this date.",
    )
    parser.add_argument(
        "--skip-news",
        action="store_true",
    ...
    print()
    print("Model 1B governed inflation nowcast complete")
